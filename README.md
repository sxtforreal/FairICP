...
3. ISIC Challenge 2018 - Task 3 (The International Skin Imaging Collaboration): T. Kalb et al pre-trained a disease detection model on ISIC Challenge 2018 - Task 3 Dataset <[Revisiting Skin Tone Fairness in Dermatological Lesion Classification]([https://www.thelancet.com/journals/ebiom/article/PIIS2352-3964(23)00032-4/fulltext](https://arxiv.org/abs/2308.09640v1))>. Data processing can be found in **CheXpert Dataset** folder.
