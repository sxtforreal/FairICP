...
1. ICM/NICM Cardiac MRI Data (Cleveland Clinic): J. Qiu et al pre-trained CMRFormer on CMR datasets <[Multimodal Representation Learning of Cardiovascular Magnetic Resonance Imaging](https://arxiv.org/abs/2304.07675)>. Data can be found in **ICMNICM Dataset** folder.
