...
from CMRFormer.base_model import BaseModel
from CMRFormer.video_transformer import SpaceTimeTransformer
from CMRFormer.util import state_dict_data_parallel_fix
...
def compute_similarity(
    a, b, a_mask=None, b_mask=None, style="single", eps=1e-8, return_raw=False, temp=0.5
):
    if style == "single":
