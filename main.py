...
##### Data prep
## ICM/NICM
icmnicm_data_dir = "./icmnicm_preds.csv"
icm_preds = pd.read_csv(icmnicm_data_dir)
icm_runs_dir = ("./icmnicm/runs/")
get_runs(icm_preds, "Female", 100, 0.5, icm_runs_dir)

## CheXpert
chexpert_data_dir = "./chexpert_preds.csv"
chexpert_preds = pd.read_csv(chexpert_data_dir)
chexpert_runs_dir = ("./chexpert/runs/")
get_runs(chexpert_preds, "race_label", 100, 0.5, chexpert_runs_dir)

## ISIC18
isic18_data_dir = "./isic18_preds.csv"
...
## Chexpert
chexpert_base = pd.read_csv("./chexpert/base.csv")
chexpert_base_cal = pd.read_csv("./chexpert/base_cal.csv")
chexpert_roc = pd.read_csv("./chexpert/roc.csv")
chexpert_icp_ag = pd.read_csv("./chexpert/icp_ag.csv")
chexpert_icp_sp = pd.read_csv("./chexpert/icp_sp.csv")
figure2(
...
## ISIC18
isic18_base = pd.read_csv("./isic18/base.csv")
isic18_base_cal = pd.read_csv("./isic18/base_cal.csv")
isic18_roc = pd.read_csv("./isic18/roc.csv")
isic18_icp_ag = pd.read_csv("./isic18/icp_ag.csv")
isic18_icp_sp = pd.read_csv("./isic18/icp_sp.csv")
figure2(
...
df1 = pd.read_csv(
    "./icmnicm/runs/run_1.csv"
)
df2 = pd.read_csv(
    "./chexpert/runs/run_1.csv"
)
df3 = pd.read_csv(
    "./isic18/runs/run_1.csv"
)
